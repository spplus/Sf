...
CASE f_caid
    ...
    WHEN 4 THEN RETURN '电视';
    WHEN 5 THEN RETURN '油烟机';
    WHEN 6 THEN RETURN '洗衣机';
	 WHEN 7 THEN RETURN '灶台';
	 WHEN 8 THEN RETURN '微波炉';
    WHEN 9 THEN RETURN '小家电';
    WHEN 10 THEN RETURN '冰柜';
    WHEN 11 THEN RETURN '微波炉';
    WHEN 12 THEN RETURN '洗碗机';
    WHEN 13 THEN RETURN '净水器';
    WHEN 14 THEN RETURN '燃气灶';
    ELSE RETURN '未知';
  END CASE;
