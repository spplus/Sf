...
@EnableConfigurationProperties({WechatMpProperties.class, WechatMpMenuProperties.class})
public class WechatMpConfiguration {
    ...
    @Autowired
    private WechatMpMenuProperties menuProperties;
    @Autowired
    ...
    public WechatMpMenuProperties getMenuProperties() {
